...
public class CheckBalanceTest extends BaseTest {
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance1","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full yes, credit card, payment done")
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance2","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan yes, plan agreed make payment yes, credit card, payment done, can i help you no, thank you")
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance5","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan no, enter amount above 110, plan agreed make payment no, remminder message")
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance6","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan yes , plan agreed make payment no, remminder message")
    public void verify_check_balance_6(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance7","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan yes, plan agreed make payment yes, credit card, payment done, can i help you ? - no, thank you")
    public void verify_check_balance_7(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance8","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan yes, plan agreed make payment no, reminder message")
    public void verify_check_balance_8(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance9","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no, enter amount below 110, set minimum payment yes, plan agreed make payment yes, credit card, payment done, can i help you? - no, thank you")
    public void verify_check_balance_9(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance10","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no , enter amount below 110, plan agreed make payment no, remminder message")
    public void verify_check_balance_10(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance11","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no , enter amount above 110, plan agreed make payment yes, credit card, payment done, can i help you - no , thank you")
    public void verify_check_balance_11(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance12","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no, enter amount above 110, plan agreed make payment no, reminder message")
    public void verify_check_balance_12(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance13","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - one time payment, enter amount below 110, credit card, plan agreed make payment, payment confirmation message")
    public void verify_check_balance_13(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance14","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full yes, ACH, payment done")
    public void verify_check_balance_14(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance15","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan yes, plan agreed make payment yes, ACH, payment done, can i help you no, thank you")
    public void verify_check_balance_15(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance16","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan no, enter amount below 110, set minimum payment yes, plan agreed make payment yes, ACH, payment done can i help you? - no , thank you")
    public void verify_check_balance_16(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance17","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan yes, recommended plan no, enter amount above 110,plan agreed make payment yes , ACH, payment done, can i help you - no, thank you")
    public void verify_check_balance_17(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance18","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no,formal repayment - payment plan, recommended plan yes, plan agreed make payment yes, ACH, payment done, can i help you ? - no, thank you")
    public void verify_check_balance_18(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance19","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no, enter amount below 110, set minimum payment yes, plan agreed make payment yes, ACH, payment done, can i help you? - no, thank you")
    public void verify_check_balance_19(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance20","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - payment plan, recommended plan no , enter amount above 110, plan agreed make payment yes, ACH, payment done, can i help you - no , thank you")
    public void verify_check_balance_20(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
    ...
    @Test(groups = {TestConstants.TEST_GROUP_SANITY, "CheckBalance21","checkBalance"}, dataProvider = "outstanding-balance-dp", description = "Verify check balance - pay in full no, setup payment plan no, formal repayment - one time payment, enter amount below 110, ACH, plan agreed make payment, payment confirmation message")
    public void verify_check_balance_21(String expectedOutstandingBalance) {
        try {
            HomePage homePageObj = new HomePage();
            Map<String,Boolean> testSteps= new LinkedHashMap<>();
            testSteps.put(TestSteps.STEP_LAUNCH_HOME_PAGE.name(),true);
